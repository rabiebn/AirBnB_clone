...
class Test_HBNB_Command_prompt(unittest.TestCase):
    """Unittests for testing prompt of the command interpreter."""
...
class Test_HBNB_Command_help(unittest.TestCase):
    """Unittests for testing help messages of the command interpreter."""
    ...
    def test_help_create(self):
        h = ("Creates a new class instance and print the id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "Signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_display(self):
        h = ("Displays the string representation of a class instance.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("Updates a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class Test_HBNB_Command_create(unittest.TestCase):
    """Unittests for testing create from the command interpreter."""
...
class Test_HBNB_Command_show(unittest.TestCase):
    """Unittests for testing show from the command interpreter"""
...
class Test_HBNB_Command_destroy(unittest.TestCase):
    """Unittests for testing destroy from the command interpreter."""
...
class Test_HBNB_Command_count(unittest.TestCase):
    """Unittests for testing count method of air BnB comand interpreter."""
