...
class Test_base_model_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        bm = BaseModel(id="345", created_at=d_t_iso, updated_at=d_t_iso)
    ...
    def test_instantiation_with_args_and_kwargs(self):
        d_t = datetime.today()
        d_t_iso = d_t.isoformat()
        bm = BaseModel("12", id="345", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(bm.id, "345")
        self.assertEqual(bm.created_at, d_t)
        self.assertEqual(bm.updated_at, d_t)
...
class Test_base_model_to_dict(unittest.TestCase):
    """Unittests for testing to dict method of the BaseModel class."""
