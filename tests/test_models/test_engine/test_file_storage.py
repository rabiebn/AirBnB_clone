...
class Test_file_storage_instantiation(unittest.TestCase):
    ...
    def test_file_storage_file_path_is_prv_str(self):
        self.assertEqual(str, type(FileStorage._FileStorage__file_path))

    def test_file_storage_objects_is_prv_dict(self):
...
class Test_file_storage_methods(unittest.TestCase):
    ...
    def test_reload_no_file(self):
        with self.assertRaises(FileNotFoundError, msg="JSON file not found"):
            models.storage.reload()
